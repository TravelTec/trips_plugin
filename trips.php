...
Description: Gerencie seus roteiros de forma prática, rápida e intuitiva. Compartilhe viagens!
Version: 1.13
Author: Travel Tec
...
function github_plugin_updater_test_init() {
	...
	define( 'WP_GITHUB_FORCE_UPDATE', true );
		...
		$config = array(
			...
			'raw_url' => 'https://raw.github.com/TravelTec/trips_plugin/master',
			'github_url' => 'https://github.com/TravelTec/trips_plugin',
			'zip_url' => 'https://github.com/TravelTec/trips_plugin/archive/main.zip',
			'sslverify' => true,
			'requires' => '1.0',
			'tested' => '1.8',
			'readme' => 'README.md',
