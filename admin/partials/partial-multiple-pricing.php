...
<div class="multiple-pricing-repeater" data-id="<?php echo esc_attr( $index ); ?>">
	...
	<div class="repeater">
		<label for="<?php echo esc_attr( $name ); ?>[extra_service][<?php echo esc_attr( $index ); ?>]">
			<?php _e( 'Service Name', 'wp-travel-engine' ); ?>
		</label>
		<input type="text" id="<?php echo esc_attr( $name ); ?>[extra_service][<?php echo esc_attr( $index ); ?>]" 
			...
			placeholder="<?php echo _e( 'Service name', 'wp-travel-engine' ); ?>" />
	</div>
	...
	<div class="repeater">
		<label for="<?php echo esc_attr( $name ); ?>[extra_service_cost][<?php echo esc_attr( $index ); ?>]">
			<?php _e( 'Service Cost', 'wp-travel-engine' ); ?>
		</label>
		<div class="number-holder">
			...
			<input type="number" name="<?php echo esc_attr( $name ); ?>[extra_service_cost][<?php echo esc_attr( $index ); ?>]" 
				...
				placeholder="<?php _e( 'Price per person', 'wp-travel-engine' ); ?>" />
		</div>
	</div>
	<!-- ./ Multiple Pricing cost -->
	...
	<div class="repeater">
		<label for="<?php echo esc_attr( $name ); ?>[extra_service_desc][<?php echo esc_attr( $index ); ?>]">
			<?php _e( 'Service Description', 'wp-travel-engine' ); ?>
			<span class="tooltip" 
				title="<?php _e( 'Select Service Unit if the service cost is Per Unit or Per Traveler. This will be displayed in the booking form in the front-end.', 'wp-travel-engine' ); ?>">
		...
		<textarea name="<?php echo esc_attr( $name ); ?>[extra_service_desc][<?php echo esc_attr( $index ); ?>]" 
			...
			placeholder="<?php _e( 'Service Description', 'wp-travel-engine' ); ?>"><?php echo esc_attr( $extra_service_desc ); ?></textarea>
	</div>
	<!-- ./ Multiple Pricing description -->
	...
	<div class="repeater">
		<label for="">
			<?php _e( 'Service Unit', 'wp-travel-engine' ); ?>
			<span class="tooltip" 
				title="<?php _e( 'Write short service description about the service. This will be displayed in the booking form in the front-end.', 'wp-travel-engine' ); ?>">
				<i class="fas fa-question-circle"></i>
			</span>
		</label>
		<div class="select-holder">
			<select name=<?php echo esc_attr( $name ); ?>[extra_service_unit][<?php echo esc_attr( $index ); ?>]>
				<option value="unit" <?php selected('unit', $extra_service_unit ); ?>>
					<?php _e( 'Per Unit', 'wp-travel-engine' ); ?>
				</option>
				<option value="traveler" <?php selected('traveler', $extra_service_unit ); ?>>
					<?php _e( 'Per Traveler', 'wp-travel-engine' ); ?>
				</option>
			</select>
		</div>
	</div>
