...

{
...

	{
		...
		$labels = array(
			...
			'edit_item'          => __('Editar roteiro', 'wp-travel-engine'),

			'view_item'          => __('View Trip', 'wp-travel-engine'),

			'all_items'          => __('Todos os roteiros', 'wp-travel-engine'),

			'search_items'       => __('Buscar viagens', 'wp-travel-engine'),
...

	{
		...
		$labels = array(
			...
			'name'               => _x('Contatos', 'post type general name', 'wp-travel-engine'),

			'singular_name'      => _x('Contato', 'post type singular name', 'wp-travel-engine'),

			'menu_name'          => _x('Contatos', 'admin menu', 'wp-travel-engine'),

			'name_admin_bar'     => _x('Contato', 'add new on admin bar', 'wp-travel-engine'),

			'add_new'            => _x('Novo Contato', 'Enquiry', 'wp-travel-engine'),

			'add_new_item'       => __('Novo Contato', 'wp-travel-engine'),

			'new_item'           => __('Novo Contatos', 'wp-travel-engine'),

			'edit_item'          => __('Editar Contato', 'wp-travel-engine'),

			'view_item'          => __('Visualizar Contato', 'wp-travel-engine'),

			'all_items'          => __('Todos os contatos', 'wp-travel-engine'),

			'search_items'       => __('Buscar Contatos', 'wp-travel-engine'),

			'parent_item_colon'  => __('Contato pai:', 'wp-travel-engine'),

			'not_found'          => __('Nenhum contato encontrado.', 'wp-travel-engine'),

			'not_found_in_trash' => __('Nenhum contato encontrado.', 'wp-travel-engine')
...

	{
		...
		$labels = array(
			...
			'name'               => _x('Reservas', 'post type general name', 'wp-travel-engine'),

			'singular_name'      => _x('Reserva', 'post type singular name', 'wp-travel-engine'),

			'menu_name'          => _x('Gerenciar Reservas', 'admin menu', 'wp-travel-engine'),

			'name_admin_bar'     => _x('Reserva', 'add new on admin bar', 'wp-travel-engine'),

			'add_new'            => _x('Nova reserva', 'Booking', 'wp-travel-engine'),

			'add_new_item'       => __('Nova reserva', 'wp-travel-engine'),

			'new_item'           => __('Nova reserva', 'wp-travel-engine'),

			'edit_item'          => __('Editar reserva', 'wp-travel-engine'),

			'view_item'          => __('', 'wp-travel-engine'),

			'all_items'          => __('Todas as reservas', 'wp-travel-engine'),

			'search_items'       => __('Buscar reservas', 'wp-travel-engine'),

			'parent_item_colon'  => __('Reserva:', 'wp-travel-engine'),

			'not_found'          => __('Nenhuma reserva encontrada.', 'wp-travel-engine'),

			'not_found_in_trash' => __('Nenhuma reserva encontrada.', 'wp-travel-engine')
...

	{
		...
		$labels = array(
			...
			'name'               => _x('Clientes', 'post type general name', 'wp-travel-engine'),

			'singular_name'      => _x('Cliente', 'post type singular name', 'wp-travel-engine'),

			'menu_name'          => _x('Clientes', 'admin menu', 'wp-travel-engine'),

			'name_admin_bar'     => _x('Cliente', 'add new on admin bar', 'wp-travel-engine'),

			'add_new'            => _x('Novo cliente', 'Customer', 'wp-travel-engine'),

			'add_new_item'       => __('Novo cliente', 'wp-travel-engine'),

			'new_item'           => __('Novo cliente', 'wp-travel-engine'),

			'edit_item'          => __('Editar cliente', 'wp-travel-engine'),

			'view_item'          => __('', 'wp-travel-engine'),

			'all_items'          => __('Todos os clientes', 'wp-travel-engine'),

			'search_items'       => __('Buscar clientes', 'wp-travel-engine'),

			'parent_item_colon'  => __('Cliente pai:', 'wp-travel-engine'),

			'not_found'          => __('Nenhum cliente encontrado.', 'wp-travel-engine'),

			'not_found_in_trash' => __('Nenhum cliente encontrado.', 'wp-travel-engine')
...

	{
		...
		$new_columns = array(
			...
			'booking_date' => __( 'Data', 'wp-travel-engine' ),

			'tname'        => __('Solicitante', 'wp-travel-engine'),

			'travelers'    => __('Passageiros', 'wp-travel-engine'),

			'booking_status' => __( 'Status', 'wp-travel-engine' ),

			'paid'         => __('Valor pago', 'wp-travel-engine'),

			'remaining'    => __('Valor restante', 'wp-travel-engine'),

			'cost'         => __('Total', 'wp-travel-engine'),
...

	{
		...
		$new_columns = array(
			...
			'enquiry_date' => __( 'Data', 'wp-travel-engine' ),

			'email'	  => __('Email', 'wp-travel-engine'),

			'preview' => __( 'Visualizar', 'wp-travel-engine' ),
...

	{
		...
		$columns['thumb_id'] 	= __('Miniatura', 'wp-travel-engine'); 

		$columns['featured'] 	= __('Destaque', 'wp-travel-engine');
...

	{
		...
		$new_columns = array( 
			...
			'country' 	=> __('Cidade', 'wp-travel-engine'),

			'bookings'  => __('Reserva', 'wp-travel-engine'),

			'spent' 	=> __('Total', 'wp-travel-engine'),

			'created' 	=> __('Data', 'wp-travel-engine'),
...

	{
		...
		$labels = array(
			...
			'name'              => _x('Local', 'taxonomy general name', 'wp-travel-engine'),

			'singular_name'     => _x('Local', 'taxonomy singular name', 'wp-travel-engine'),

			'search_items'      => __('Buscar locais', 'wp-travel-engine'),

			'all_items'         => __('Todos os locais', 'wp-travel-engine'),

			'parent_item'       => __('Local Pai', 'wp-travel-engine'),

			'parent_item_colon' => __('Local Pai', 'wp-travel-engine'),

			'edit_item'         => __('Editar Local', 'wp-travel-engine'),

			'update_item'       => __('Editar Local', 'wp-travel-engine'),

			'add_new_item'      => __('Novo local', 'wp-travel-engine'),
...

	{
		...
		$labels = array(
			...
			'name'              => _x('Atividades', 'taxonomy general name', 'wp-travel-engine'),

			'singular_name'     => _x('Atividades', 'taxonomy singular name', 'wp-travel-engine'),

			'search_items'      => __('Buscar Atividades', 'wp-travel-engine'),

			'all_items'         => __('Todas as atividades', 'wp-travel-engine'),

			'parent_item'       => __('Atividade Pai', 'wp-travel-engine'),

			'parent_item_colon' => __('Atividade Pai', 'wp-travel-engine'),

			'edit_item'         => __('Editar atividade', 'wp-travel-engine'),

			'update_item'       => __('Editar atividade', 'wp-travel-engine'),

			'add_new_item'      => __('Nova atividade', 'wp-travel-engine'),

			'new_item_name'     => __('Nome novo atividade', 'wp-travel-engine'),

			'menu_name'         => __('Atividades', 'wp-travel-engine'),
...

	{
		...
		$labels = array(
			...
			'name'              => _x('Tipo da viagem', 'taxonomy general name', 'wp-travel-engine'),

			'singular_name'     => _x('Tipo da viagem', 'taxonomy singular name', 'wp-travel-engine'),

			'search_items'      => __('Buscar tipo da viagem', 'wp-travel-engine'),

			'all_items'         => __('Todos os tipos de viagem', 'wp-travel-engine'),

			'parent_item'       => __('Tipo de viagem pai', 'wp-travel-engine'),

			'parent_item_colon' => __('Tipo de viagem pai', 'wp-travel-engine'),

			'edit_item'         => __('Editar tipo da viagem', 'wp-travel-engine'),

			'update_item'       => __('Editar tipo da viagem', 'wp-travel-engine'),

			'add_new_item'      => __('Novo tipo de viagem', 'wp-travel-engine'),

			'new_item_name'     => __('Novo tipo de viagem', 'wp-travel-engine'),

			'menu_name'         => __('Tipo de viagem', 'wp-travel-engine'), 
...

	{
		...
		add_submenu_page('edit.php?post_type=booking', 'WP Travel Engine Admin Settings', 'Configurações', 'manage_options', basename(__FILE__), array($this, 'wp_travel_engine_callback_function'));
	...
	*/
...

	{
		...
		foreach ($screens as $screen) {
			...
			add_meta_box(
				...
				__('Detalhes de pagamento - Paypal', 'wp-travel-engine'),
...

	{
		...
		add_submenu_page('edit.php?post_type=booking', 'Importar roteiros', 'Operadoras', 'manage_options', 'extensions', array($this, 'wp_travel_engine_extensions_callback_function'));
...

	{
		...
		add_submenu_page('edit.php?post_type=booking', 'Themes for WP Travel Engine.', 'Temas', 'manage_options', 'themes', array($this, 'wp_travel_engine_themes_callback_function'));
...

	{
		...
		$new_columns = array(
			...
			'tid' => __('ID da viagem', 'wp-travel-engine'),
...
<?php
	...
	function wp_travel_engine_trips_columns( $itinerary_columns ) {
		...
		$itinerary_columns['featured']      = __( 'Destaque', 'wp-travel-engine' );
	...
	function wpte_tab_trip_save_and_continue_callback() {
		...
		if ( isset( $_POST['action'] ) && 'wpte_tab_trip_save_and_continue' === $_POST['action'] ) {
			...
			wp_send_json_success( array( 'message' => 'Informações do roteiro salvas com sucesso.' ) );
		...
		if ( $trip_code_edit ) {
			...
			?>
				...
				<div class="wpte-field wpte-trip-code wpte-floated">
					...
					<label class="wpte-field-label"><?php _e( 'ID do roteiro', 'wp-travel-engine' ); ?></label>
					...
					<!-- <div class="wpte-info-block">
						...
						<p>
								...
								//echo sprintf( __( 'Precisa editar  Need to edit trip code to set your own? Trip Code extension allows you to add unique trip code to your trips. %1$sGet Trip Code extension now%2$s.', 'wp-travel-engine' ), '<a target="_blank" href="https://wptravelengine.com/downloads/trip-code/?utm_source=setting&utm_medium=customer_site&utm_campaign=setting_addon">', '</a>' );
