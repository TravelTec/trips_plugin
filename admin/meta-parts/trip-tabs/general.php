...
// Get DB values.
$trip_type   = isset( $wp_travel_engine_setting['trip_type'] ) ? $wp_travel_engine_setting['trip_type'] : false;
$nome_cliente   = isset( $wp_travel_engine_setting['nome_cliente'] ) ? $wp_travel_engine_setting['nome_cliente'] : false;
$e_mail_cliente   = isset( $wp_travel_engine_setting['e_mail_cliente'] ) ? $wp_travel_engine_setting['e_mail_cliente'] : false;
...
function generate_id_app($length = 16) {
    return substr(str_shuffle("0123456789ABCDEF"), 0, $length);
} 

$token = generate_id_app();
