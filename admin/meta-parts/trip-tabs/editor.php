    ...
    <div class="wpte-form-block-wrap">
        ...
        <div class="wpte-form-block">
            ...
            <div class="wpte-form-content">
                ...
                <label for="wp_travel_engine_setting_tab_<?php echo esc_attr( $tab_key ) ?>_wpeditor" class="wpte-field-label"><?php _e( 'Tour Description', 'wp-travel-engine' ); ?></label>
                        <textarea 
                            ...
                            class="wte-editor-area wp-editor-area" id="wp_travel_engine_setting_tab_<?php echo esc_attr( $tab_key ) ?>_wpeditor"><?php echo html_entity_decode( $tab_content ); ?></textarea>
