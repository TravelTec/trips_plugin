...
$overview_section_title = isset( $wp_travel_engine_setting['overview_section_title'] ) ? $wp_travel_engine_setting['overview_section_title'] : __( 'Overview', 'wp-travel-engine' );

?>
    <div class="wpte-form-block-wrap">
    <div class="wpte-form-block">
            <div class="wpte-title-wrap">
                <h2 class="wpte-title"><?php _e( 'Descrição do roteiro', 'wp-travel-engine' ); ?></h2>
            </div>
            <div class="wpte-form-content">
                <div class="wpte-field wpte-text wpte-floated">
                    ...
                    <input type="text" name="wp_travel_engine_setting[overview_section_title]" value="<?php echo esc_attr( $overview_section_title ); ?>" placeholder="Informe aqui">
                    <span class="wpte-tooltip"><?php _e( 'Informe o título da seção de resumo', 'wp-travel-engine' ); ?></span>
                </div>
                
                <div class="wpte-field wpte-textarea wpte-floated wpte-rich-textarea delay">
                    <label class="wpte-field-label"><?php _e( 'Descrição da viagem', 'wp-travel-engine' ); ?></label>
                    <!-- <div class="wte-editor-notice">
                        <?php _e('Click to initialize RichEditor', 'wp-travel-engine'); ?>
                    </div> -->
                    <textarea 
                        placeholder="<?php _e('Resumo do roteiro:', 'wp-travel-engine'); ?>"
                        name="wp_travel_engine_setting[tab_content][1_wpeditor]"
                        class="wte-editor-area wp-editor-area" id="WTE_Trip_Overview"
                        ><?php echo wp_kses_post( $overview_content ); ?></textarea>
                    <span class="wpte-tooltip"><?php _e( 'Conteúdo da seção de resumo', 'wp-travel-engine' ) ?></span>
                </div>
            </div>
        </div> <!-- .wpte-form-block -->
        <div class="wpte-form-block">
            <div class="wpte-title-wrap">
                <h2 class="wpte-title"><?php _e( 'Destaques do roteiro', 'wp-travel-engine' ); ?></h2>
            </div>
            <div class="wpte-form-content">
                <div class="wpte-field wpte-text wpte-floated">
                    <label class="wpte-field-label"><?php _e( 'Título da seção', 'wp-travel-engine' ); ?></label>
                    <input type="text" name="wp_travel_engine_setting[trip_highlights_title]" value="<?php echo esc_attr( $trip_highlights_title ); ?>" placeholder="Informe aqui">
                    <span class="wpte-tooltip"><?php _e( 'Informe o título para a seção de destaques da viagem.', 'wp-travel-engine' ) ?></span>
                </div>
                ...
                <div class="wpte-repeater-wrap wpte-trip-highlights-hldr">
                    ...
                    ?>
                        <div class="wpte-repeater-block wpte-sortable wpte-trp-highlight">
                            <div class="wpte-field wpte-field-gray wpte-floated">
                                <input required type="text" name="wp_travel_engine_setting[trip_highlights][<?php echo esc_attr( $key ); ?>][highlight_text]" value="<?php echo esc_attr( $highlight['highlight_text'] ); ?>" placeholder="<?php esc_attr_e( 'Enter trip highlight', 'wp-travel-engine' ); ?>">
                    ...
                    <script type="text/html" id="tmpl-tour-highlight-row">
                        <div class="wpte-repeater-block wpte-sortable wpte-trp-highlight">
                            <div class="wpte-field wpte-field-gray wpte-floated">
                                <input required type="text" name="wp_travel_engine_setting[trip_highlights][{{data.key}}][highlight_text]" value="" placeholder="<?php esc_attr_e( 'Informe o destaque da viagem', 'wp-travel-engine' ); ?>">
                                <button class="wpte-delete wte-delete-highlight"></button>
                            </div>
                        </div> <!-- .wpte-repeater-block -->
                    </script>
                ...
                <div class="wpte-add-btn-wrap">
                    <button class="wpte-add-btn wte-add-trip-highlight"><?php esc_html_e( 'Adicionar destaque', 'wp-travel-engine' ); ?></button>
                </div>
            </div>
        </div> <!-- .wpte-form-block -->
