                ...
                <li id="itinerary-tabs<?php echo esc_attr($value); ?>" data-id="<?php echo esc_attr($value); ?>" class="itinerary-row">
                    ...
                    <div class="itinerary-holder">
                        ...
                        <div class="itinerary-content">
                            <div class="title">
                                <input placeholder="<?php _e('Itinerary Title:', 'wp-travel-engine'); ?>" type="text" class="itinerary-title" name="wp_travel_engine_setting[itinerary][itinerary_title][<?php echo esc_attr($value); ?>]" id="wp_travel_engine_setting[itinerary][itinerary_title][<?php echo esc_attr($value); ?>]" value="<?php echo (isset($wp_travel_engine_tabs['itinerary']['itinerary_title'][$value]) ? esc_attr($wp_travel_engine_tabs['itinerary']['itinerary_title'][$value]) : ''); ?>">
                            </div>
                            <div class="content">
                                <textarea placeholder="<?php _e('Itinerary Content:', 'wp-travel-engine'); ?>" rows="5" cols="32" class="itinerary-content" name="wp_travel_engine_setting[itinerary][itinerary_content][<?php echo esc_attr($value); ?>]" id="wp_travel_engine_setting[itinerary][itinerary_content][<?php echo esc_attr($value); ?>]"><?php echo (isset($wp_travel_engine_tabs['itinerary']['itinerary_content'][$value]) ? esc_attr($wp_travel_engine_tabs['itinerary']['itinerary_content'][$value]) : ''); ?></textarea>
