...
class Wp_Travel_Engine {
	...
	private function load_dependencies() {
		 ...
		 * The class responsible for activities.

		 */

		require WP_TRAVEL_ENGINE_BASE_PATH . '/includes/class-wp-travel-engine-activities.php';



		/**

		 * The class responsible for trip types.

		 */

		require WP_TRAVEL_ENGINE_BASE_PATH . '/includes/class-wp-travel-engine-trip-types.php';



		/**

		 * The class responsible for destinations.

		 */

		require WP_TRAVEL_ENGINE_BASE_PATH . '/includes/class-wp-travel-engine-destinations.php';
	...
	public function init_shortcodes() {
		...
		$plugin_shortcode = new Wp_Travel_Engine_Activities();

		$plugin_shortcode->init();

		$plugin_shortcode = new Wp_Travel_Engine_Trip_Types();
