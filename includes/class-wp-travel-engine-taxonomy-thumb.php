...
public function wpte_add_category_image ( $taxonomy ) { ?>
	<div class="form-field term-group">
		<label for="category-image-id"><?php _e('Imagem', 'wp-travel-engine'); ?></label>
		<input type="hidden" id="category-image-id" name="category-image-id" class="custom_media_url" value="">
		<div id="category-image-wrapper"></div>
		<p>
			<input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button" name="ct_tax_media_button" value="<?php _e( 'Adicionar imagem', 'wp-travel-engine' ); ?>" />
			<input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove" name="ct_tax_media_remove" value="<?php _e( 'Remover imagem', 'wp-travel-engine' ); ?>" />
		</p>
	</div>
<?php
}
...
public function add_editor_field_description( $tag, $taxonomy  ) {
    ...
    <tr class="form-field term-description-wrap">
        <th scope="row"><label for="description"><?php _e( 'Description', 'wp-travel-engine' ); ?></label></th>
        <td>
...
function add_shortdesc_in_wte(){
    ?>
		<div class="form-field term-group">
			<label for="wte-shortdesc-textarea"><?php _e('Pequena descição', 'wp-travel-engine'); ?></label>
...
function save_shortdesc_in_wte( $term_id ){
    if( isset( $_POST['wte-shortdesc-textarea'] ) && '' !== $_POST['wte-shortdesc-textarea'] ){
        ...
        add_term_meta( $term_id, 'wte-shortdesc-textarea', $_POST['wte-shortdesc-textarea'],false );
    }
}
...
function update_shortdesc_in_wte( $term ){
    ...
    <tr class="form-field">
        <th valign="top" scope="row">
            <label for="wte-shortdesc-textarea"> <?php _e('Short Description', 'wp-travel-engine'); ?> </label>
        </th>
        <td>
            <textarea name="wte-shortdesc-textarea" id="wte-shortdesc-textarea"><?php echo wp_kses_post( $term_category_textarea ); ?></textarea>
            <p class="description"><?php _e('This short description is used in taxonomy listing pages', 'wp-travel-engine'); ?></p>
        </td>
    </tr>
    <?php 
}
...
function updated_shortdesc_in_wte( $term_id ){
    if( isset( $_POST['wte-shortdesc-textarea'] ) && '' !== $_POST['wte-shortdesc-textarea'] ){
        update_term_meta ( $term_id, 'wte-shortdesc-textarea', $_POST['wte-shortdesc-textarea'] );
	} else {
