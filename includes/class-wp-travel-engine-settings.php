	...
	public function get_global_settings_tabs() {
		...
		$global_tabs = array(
			...
			'wpte-general'       => array(
				...
				'label'    => __( 'Geral', 'wp-travel-engine' ),

				'sub_tabs' => array(

					'page_settings' => array(

						'label'        => __( 'Configuração de páginas', 'wp-travel-engine' ),
					...
					'trip_tabs'     => array(
						...
						'label'        => __( 'Tabs de viagem', 'wp-travel-engine' ),
					...
					'trip_info'     => array(
						...
						'label'        => __( 'Informação da viagem', 'wp-travel-engine' ),
			...
			'wpte-emails'        => array(
				...
				'label'    => __( 'E-mails', 'wp-travel-engine' ),
				...
				'sub_tabs' => array(
					...
					'purchase_receipt'      => array(
						...
						'label'        => __( 'Recebimento de Compra', 'wp-travel-engine' ),
					...
					'booking_notifications' => array(
						...
						'label'        => __( 'Notificação de reserva', 'wp-travel-engine' ),
			...
			'wpte-miscellaneous' => array(
				...
				'label'    => __( 'Miscelanea', 'wp-travel-engine' ),

				'sub_tabs' => array(

					'currency'  => array(

						'label'        => __( 'Configuração de moeda', 'wp-travel-engine' ),
					...
					'show-hide' => array(
						...
						'label'        => __( 'Configuração de exibição', 'wp-travel-engine' ),
			...
			<header class="wpte-header">
				...
				<div class="wpte-left-block">
					...
					<h1 class="wpte-plugin-title">
						...
						<?php esc_html_e( 'Gerenciar viagens', 'wp-travel-engine' ); ?>

					</h1>

					<span class="wpte-page-name"><?php esc_html_e( 'Configuração', 'wp-travel-engine' ); ?></span>
						...
						<div class="wpte-tab-content <?php echo esc_attr( $key ); ?>-content <?php echo isset( $tab['current'] ) ? 'current content_loaded' : ''; ?> wpte-global-settngstab">
							...
							<div class="wpte-block-content">
								...
								<div class="wpte-field wpte-submit">
									...
									<input data-tab="<?php echo esc_attr( $key ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'wpte-global-setting-save' ) ); ?>" class="wpte-save-global-settings" type="submit" name="wpte_save_global_settings" value="<?php esc_attr_e( 'Salvar e Continuar', 'wp-travel-engine' ); ?>">
