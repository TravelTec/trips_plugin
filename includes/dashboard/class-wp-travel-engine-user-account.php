 ...
 */
class Wp_Travel_Engine_User_Account {
	...
	private static function dashboard_menus() {
		$dashboard_menus = array(
			'dashboard' => array(
				'menu_title'      => __( 'Dashboard', 'wp-travel-engine' ),
				'menu_class'      => 'lrf-dashboard',
				'menu_content_cb' => array( __CLASS__, 'dashboard_menu_dashboard_tab' ),
				'priority'        => 10,
			),
			'bookings' => array(
				'menu_title'      => __( 'Bookings', 'wp-travel-engine' ),
	...
	public static function dashboard_menu_logout_tab( $args ) {
		wte_get_template( 'account/tab-content/logout.php', $args );
	}
	...
	public static function retrieve_password() {
		...
		$email_content = wte_get_template_html( 'emails/customer-lost-password.php', array( 'user_login' => $user_login, 'reset_key' => $key ) );
