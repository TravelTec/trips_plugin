...
class Wp_Travel_Engine_Mail_Template
{
	...
	function mail_editor( $settings, $pid )
	{
		...
		$code = wp_travel_engine_get_currency_code( true );
        $obj = new Wp_Travel_Engine_Functions();
        $currency = wp_travel_engine_get_currency_symbol( $code );

		$price = wp_travel_engine_get_formated_price_with_currency_code_symbol( $settings['place_order']['cost'], null, true );
		$due = isset( $settings['place_order']['due'] ) ? wp_travel_engine_get_formated_price_with_currency_code_symbol( $settings['place_order']['due'], null, true ) : '' ;
		...
		$total_cost = wp_travel_engine_get_formated_price_with_currency_code_symbol( $total_cost, null, true );
		...
		$tprice = wp_travel_engine_get_formated_price_with_currency_code_symbol( $tripprice, null, true );
