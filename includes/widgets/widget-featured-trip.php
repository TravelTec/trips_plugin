...
class WTE_Featured_Trips_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Title:', 'wp-travel-engine' ); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_name( 'num_post' ); ?>"><?php _e( 'Number of Posts:', 'wp-travel-engine' ); ?></label>
