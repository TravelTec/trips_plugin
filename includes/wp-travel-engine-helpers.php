...
function wp_travel_engine_get_currency_code( $use_default_currency_code = false ) {
	...
	return $wp_travel_engine_settings;
...
function wp_travel_engine_get_available_payment_gateways( $gateways_list = array() ) {
	...
	$gateways_list = array(
		...
		'booking_only'         => array(
			...
			'info_text'    => __( 'Se selecionado, nenhum gateway de pagamento vai ser usado no checkout. O processo de reserva vai ser completado e a reserva vai ser salva sem pagamento.', 'wp-travel-engine' ),
...
function wte_get_default_settings_tab() {
	...
	$default_tabs = array(
		...
		'name'  => array(
			...
			'1' => __( 'Resumo', 'wp-travel-engine' ),

			'2' => __( 'Itinerário', 'wp-travel-engine' ),

			'3' => __( 'Incluso', 'wp-travel-engine' ),

			'4' => __( 'Datas', 'wp-travel-engine' ),

			'5' => __( 'FAQs', 'wp-travel-engine' ),

			'6' => __( 'Mapa', 'wp-travel-engine' ),
...
function wte_get_featured_trips_array() {
	...
	$feat_trip_num = isset( $wte_global['feat_trip_num'] ) ? $wte_global['feat_trip_num'] : 1;
