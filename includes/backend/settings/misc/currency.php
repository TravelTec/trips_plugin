    ...
    <div class="wpte-form-block">
        <div class="wpte-form-content">
            <div class="wpte-field wpte-select wpte-floated">
                <label class="wpte-field-label" for="wp_travel_engine_settings[currency_code]"><?php _e('Moeda de pagamento','wp-travel-engine'); ?>
                </label>
            ...
            <div class="wpte-field wpte-select wpte-floated">
                <label class="wpte-field-label"><?php _e('Exibir Moeda ou Código','wp-travel-engine');?></label>
                <select id="wp_travel_engine_settings[currency_option]" name="wp_travel_engine_settings[currency_option]" data-placeholder="<?php esc_attr_e( 'Choose a option&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select">
                    ...
                    foreach ( $options as $key => $val ) {
                        echo '<option value="' .( !empty($key) ? esc_attr( $key ) : "Selecione")  . '" ' . selected( $option, $key, false ) . '>' . esc_html( $val ) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="wpte-field wpte-select wpte-floated">
                <label for="wp_travel_engine_settings[thousands_separator]" class="wpte-field-label"><?php esc_html_e( 'separador de milhar', 'wp-travel-engine' ); ?></label>
