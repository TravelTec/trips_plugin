...
<div class="wpte-field wpte-floated">
	<label
		...
		for="wp_travel_engine_settings[bank_transfer][title]"
	><?php esc_html_e( 'Title', 'wp-travel-engine' ); ?></label>
	<input
		type="text"
...
<div class="wpte-field wpte-floated">
	<label
		class="wpte-field-label"
		for="wp_travel_engine_settings[bank_transfer][description]"
	><?php esc_html_e( 'Description', 'wp-travel-engine' ); ?></label>
	<textarea
		type="text"
		id="wp_travel_engine_settings[bank_transfer][description]"
		name="wp_travel_engine_settings[bank_transfer][description]"
...
<div class="wpte-field wpte-floated">
	<label
		class="wpte-field-label"
		for="wp_travel_engine_settings[bank_transfer][instruction]"
	><?php esc_html_e( 'Instructions', 'wp-travel-engine' ); ?></label>
	<textarea
		type="text"
		id="wp_travel_engine_settings[bank_transfer][instruction]"
		name="wp_travel_engine_settings[bank_transfer][instruction]"
	><?php echo esc_attr( $instruction ); ?></textarea>
	<span
...
<div class="wpte-field wpte-floated">
	<label
		class="wpte-field-label"
		for="wp_travel_engine_settings[bank_transfer][accounts]"
	><?php esc_html_e( 'Account Details', 'wp-travel-engine' ); ?></label>
