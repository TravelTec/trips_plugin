...
<div class="wpte-field wpte-floated">
	<label
		...
		for="wp_travel_engine_settings[check_payment][title]"
...
<div class="wpte-field wpte-floated">
	<label
		class="wpte-field-label"
		for="wp_travel_engine_settings[check_payment][description]"
	><?php esc_html_e( 'Description', 'wp-travel-engine' ); ?></label>
	<textarea
		type="text"
		id="wp_travel_engine_settings[check_payment][description]"
		name="wp_travel_engine_settings[check_payment][description]"
...
<div class="wpte-field wpte-floated">
	<label
		class="wpte-field-label"
		for="wp_travel_engine_settings[check_payment][instruction]"
	><?php esc_html_e( 'Instructions', 'wp-travel-engine' ); ?></label>
	<textarea
		type="text"
		id="wp_travel_engine_settings[check_payment][instruction]"
		name="wp_travel_engine_settings[check_payment][instruction]"
