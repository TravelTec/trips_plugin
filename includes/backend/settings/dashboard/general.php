...
<div class="wpte-field wpte-checkbox advance-checkbox">
    <label class="wpte-field-label" for="wp_travel_engine_settings[enable_checkout_customer_registration]"><?php _e('Require Customer Registration To Book Trips','wp-travel-engine');?></label>
...
<div class="wpte-field wpte-checkbox advance-checkbox">
    <label class="wpte-field-label" for="wp_travel_engine_settings[disable_my_account_customer_registration]"><?php _e('Disable Customer Registration On "Dashboard" Page','wp-travel-engine');?></label>
    <div class="wpte-checkbox-wrap">
...
<div class="wpte-field wpte-checkbox advance-checkbox">
    <label class="wpte-field-label" for="wp_travel_engine_settings[generate_username_from_email]"><?php _e('Automatically Generate Username From Customer Email','wp-travel-engine');?></label>
    <div class="wpte-checkbox-wrap">
...
<div class="wpte-field wpte-checkbox advance-checkbox">
    <label class="wpte-field-label" for="wp_travel_engine_settings[generate_user_password]"><?php _e('Automatically Generate Customer Password','wp-travel-engine');?></label>
    <div class="wpte-checkbox-wrap">
