...
<div class="wpte-field wpte-text wpte-floated">
	<label class="wpte-field-label" for="wp_travel_engine_settings[email][name]"><?php _e( 'Remetente', 'wp-travel-engine' ); ?></label>
...
<div class="wpte-field wpte-email wpte-floated">
	<label class="wpte-field-label" for="wp_travel_engine_settings[email][from]"><?php _e( 'E-mail Remetente', 'wp-travel-engine' ); ?></label>
...
<div class="wpte-field wpte-text wpte-floated">
	<label class="wpte-field-label" for="wp_travel_engine_settings[email][subject]"><?php _e( 'Assunto do e-mail', 'wp-travel-engine' ); ?></label>
...
<div class="wpte-field wpte-textarea wpte-floated">
	<label class="wpte-field-label" for="purchase_wpeditor"><?php _e( 'Mensagem', 'wp-travel-engine' ); ?></label>
		<?php
