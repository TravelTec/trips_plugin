...
$pages   = array(
    'wte-checkout-page' => array(
        'label' => __( 'Pagina de Checkout', 'wp-travel-engine' ),
    ...
    'wte-terms-page' => array(
        'label' => __( 'Termos e Condições', 'wp-travel-engine' ),
    ...
    'wte-thankyou-page' => array(
        'label' => __( 'Pagina de reserva finalizada', 'wp-travel-engine' ),
    ...
    'wte-confirmation-page' => array(
        'label' => __( 'Pagina de confirmação', 'wp-travel-engine' ),
    ...
    'wte-enquiry-thank-you' => array(
        'label' => __( 'Pagina de recebimento de contato', 'wp-travel-engine' ),
