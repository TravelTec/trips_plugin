        ...
        <div class="wpte-repeater-block-holder wte-global-tabs-holder">
            ...
            ?>
                        <div class="wpte-repeater-block wpte-sortable wpte-glb-tab-row">
                            ...
                            <input type="hidden" class="trip-tabs-field" name="wp_travel_engine_settings[trip_tabs][field][<?php  echo $value;?>]" id="wp_travel_engine_settings[trip_tabs][field][<?php echo $value;?>]" 
                            value="<?php echo esc_attr( $field_id ); ?>">
                            <div class="wpte-field">
                                <input type="text" name="wp_travel_engine_settings[trip_tabs][name][<?php echo $value;?>]" id="wp_travel_engine_settings[trip_tabs][name][<?php echo $value;?>]" 
                            ...
                            <div class="wpte-icons-holder wpte-floated">
                                <button class="wpte-add-icon"><?php echo ! empty( $tab_icon ) ? esc_html__( 'Editar ícone', 'wp-travel-engine' ) : esc_html__( 'Adicionar ícone', 'wp-travel-engine' ); ?></button>
                                    <span class="wpte-icon-preview">
                                        <span class="wpte-icon-holdr">
                                            <i class="<?php echo ! empty( $tab_icon ) ? esc_attr( $tab_icon ) : ''; ?>"></i>
                                        </span>
                                        <button class="wpte-remove-icn-btn"><?php echo esc_html( 'Remove' ); ?></button>
                                    </span>
                                <input type="hidden" class="trip-tabs-icon" name="wp_travel_engine_settings[trip_tabs][icon][<?php echo $value;?>]" id="wp_travel_engine_settings[trip_tabs][icon][<?php echo $value;?>]" 
                                value="<?php echo esc_attr( $tab_icon ); ?>">
                            </div>
                            <div class="wpte-system-btns">
                                <div class="wpte-field wpte-checkbox advance-checkbox">
                                        <input type="hidden" name="wp_travel_engine_settings[trip_tabs][enable][<?php echo $value;?>]" value="no">
                                    <div class="wpte-checkbox-wrap">
                                        <input type="checkbox" id="wp_travel_engine_settings[trip_tabs][enable][<?php echo $value;?>]" name="wp_travel_engine_settings[trip_tabs][enable][<?php echo $value;?>]" value="yes" <?php checked( $enabled, 'yes' ); ?> >
                                        <label for="wp_travel_engine_settings[trip_tabs][enable][<?php echo $value;?>]" class="checkbox-label"></label>
                                    </div>
                                </div>
                                <?php 
                                $def_tabs = array(
                                ...
                                $field = $wp_travel_engine_tabs['trip_tabs']['field'][$tab_id];
                                if ( '1' !== $tab_id && ! in_array( $field , $def_tabs ) ) : ?>
    ...
    <script type="text/html" id="tmpl-wpte-glb-tabs-row" >
        <div class="wpte-repeater-block wpte-sortable wpte-glb-tab-row">
            ...
            <div class="wpte-icons-holder wpte-floated">
                ...
                <input type="hidden" class="trip-tabs-icon" name="wp_travel_engine_settings[trip_tabs][icon][{{data.key}}]" id="wp_travel_engine_settings[trip_tabs][icon][{{data.key}}]" 
                value="">
            </div>
            <div class="wpte-system-btns">
                <div class="wpte-field wpte-checkbox advance-checkbox">
