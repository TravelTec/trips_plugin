...
<div class="wpte-repeater-wrap">
    ...
    <div class="wpte-repeater-heading">
        ...
        <div class="wpte-repeater-title"><?php esc_html_e( 'Nome', 'wp-travel-engine' ) ?></div>

        <div class="wpte-repeater-title"><?php esc_html_e( 'Ícone', 'wp-travel-engine' ) ?></div>

        <div class="wpte-repeater-title"><?php esc_html_e( 'Tipo', 'wp-travel-engine' ) ?></div>

        <div class="wpte-repeater-title"><?php esc_html_e( 'Placeholder', 'wp-travel-engine' ) ?></div>
                    ...
                    ?>
                        ...
                        <div class="wpte-repeater-block wpte-sortable wpte-glb-trp-infos-row">
                            ...
                            <div class="wpte-icons-holder wpte-floated">
                                ...
                                <button class="wpte-add-icon"><?php echo ! empty( $fact_icon ) ? esc_html__( 'Alterar', 'wp-travel-engine' ) : esc_html__( 'Adicionar info', 'wp-travel-engine' ); ?></button>
                                ...
                                <span class="wpte-icon-preview">
                                    ...
                                    <button class="wpte-remove-icn-btn"><?php echo esc_html( 'Remover' ); ?></button>
                            ...
                            <div class="wpte-trp-inf-fieldtyp wpte-field">
                                ...
                                <select id="wp_travel_engine_settings[trip_facts][field_type][<?php echo $value;?>]" name="wp_travel_engine_settings[trip_facts][field_type][<?php echo $value;?>]" data-placeholder="<?php esc_attr_e( 'Selecionar&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select">

                                        <option value=" "><?php _e( 'Selecionar&hellip;', 'wp-travel-engine' ); ?></option>
                                    ...
                                    <?php
                                        ...
                                        echo '<option value="' .( !empty($key)?esc_attr( $key ):"Selecione")  . '" ' . selected( $selected_field, $val, false ) . '>' . esc_html( $key ) . '</option>';
...
<div class="wpte-add-btn-wrap">
    ...
    <button class="wpte-add-btn wpte-add-glb-trp-info"><?php esc_html_e( 'Adicionar info', 'wp-travel-engine' ); ?></button>
...
<script type="text/html" id="tmpl-wpte-add-trip-info-block">
    ...
    <div class="wpte-repeater-block wpte-sortable wpte-glb-trp-infos-row">
        ...
        <div class="wpte-icons-holder wpte-floated">
            ...
            <button class="wpte-add-icon"><?php echo esc_html__( 'Adicionar info', 'wp-travel-engine' ); ?></button>
        ...
        <div class="wpte-trp-inf-fieldtyp wpte-field">
            ...
            <select id="wp_travel_engine_settings[trip_facts][field_type][{{data.key}}]" name="wp_travel_engine_settings[trip_facts][field_type][{{data.key}}]" data-placeholder="<?php esc_attr_e( 'Choose a field type&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select">
                ...
                <?php
                    ...
                    echo '<option value="' .( !empty($key)?esc_attr( $key ):"Selecione")  . '">' . esc_html( $key ) . '</option>';
        ...
        <div class="wpte-field">
            ...
            <div style="display:none" class="select-options">
                ...
                <textarea id="wp_travel_engine_settings[trip_facts][select_options][{{data.key}}]" name="wp_travel_engine_settings[trip_facts][select_options][{{data.key}}]" rows="2" cols="25" required placeholder="<?php _e( 'Informe os valores separados por vírgula','wp-travel-engine' );?>"></textarea>
...
<div>
	...
	<h2 class="wpte-lrf-title"><?php _e( 'Miníma/Maxima Idade', 'wp-travel-engine' ); ?></h2>
	...
	<div class="wpte-field wpte-icons-holder wpte-floated">
		...
		<label class="wpte-field-label" for="wp_travel_engine_settings[trip_minimum_age_icon]"><?php _e('Ícone idade Miníma','wp-travel-engine');?></label>

		<button class="wpte-add-icon"><?php echo esc_html__( 'Idade Miníma', 'wp-travel-engine' ); ?></button>
	...
	<div class="wpte-field wpte-icons-holder wpte-floated">
		...
		<label class="wpte-field-label" for="wp_travel_engine_settings[trip_maximum_age_icon]"><?php _e('Ícone idade Maxima', 'wp-travel-engine');?></label>

		<button class="wpte-add-icon"><?php echo esc_html__( 'Idade Maxima', 'wp-travel-engine' ); ?></button>
