...
<div class="wpte-block-wrap" style="border-top: 1px solid #e9e9e9;border-bottom: 0;">

    <div class="wpte-block">

        <div class="wpte-title-wrap">

            <h4 class="wpte-title"><?php _e( 'Detalhes dos hóspedes', 'wp-travel-engine' ); ?></h4>
                    ...
                    ?>
                        ...
                        <div class="wpte-toggle-item">
                            ...
                            <div class="wpte-toggle-title">
                                ...
                                <a href="Javascript:void(0);"><?php printf( __( 'Hóspede %1$s', 'wp-travel-engine' ), $i ); ?></a>
                            ...
                            <div class="wpte-toggle-content">
                                ...
                                <div class="wpte-prsnl-dtl-blk wpte-floated">  
                                        ...
                                        <h4><?php _e( 'Informação do hóspede', 'wp-travel-engine' ); ?></h4>
