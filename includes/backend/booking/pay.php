...
<div class="trip-info-meta">
	<label class="wpte-field-label" for="wp_travel_engine_booking_setting[place_order][payment][payment_status]"><?php _e('Payment Status: ','wp-travel-engine');?></label>
	...
	<label class="wpte-field-label" for="wp_travel_engine_booking_setting[place_order][payment][payer_status]"><?php _e('Payer Status: ','wp-travel-engine');?></label>
	...
	<label class="wpte-field-label" for="wp_travel_engine_booking_setting[place_order][payment][payment_type]"><?php _e('Payment Type: ','wp-travel-engine');?></label>
	<div class="wpte-field wpte-text">
	...
	<label class="wpte-field-label" for="wp_travel_engine_booking_setting[place_order][payment][txn_id]"><?php _e('Transaction ID: ','wp-travel-engine');?></label>
	<div class="wpte-field wpte-text">
