                        ...
                        ?>
                            <div class='wp-travel-engine-personal-details'>
                                ...
                                switch ($key) {
                                    ...
                                    case 'passport': ?> 
                                    <label for="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]"><?php _e('Passport Number','wp-travel-engine');?></label>
                                    <input type="text" value="<?php echo isset( $value[$i] ) ? esc_attr( $value[$i] ): '';?>" name="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" id="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" > 
                                    <?php
                                    break;
                                    ...
                                    ?>
                                        <label for="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]"><?php echo esc_html( $label_data ); ?></label>
                                        <input class="wp-travel-engine" value="<?php echo isset( $value[$i] ) ? esc_attr( $value[$i] ): '';?>" type="text" name="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" id="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" >
                                    <?php
                                    break;
                                } ?>
                            </div>
                            ...
                            foreach ($relation_options['relation'] as $key => $value) { ?>
                                <div class='wp-travel-engine-relation-details'>
                                    ...
                                    switch ($key) { 
                                        ...
                                        ?>
                                            <label for="wp_travel_engine_booking_setting[place_order][relation][<?php echo esc_attr( $key );?>][<?php echo $i;?>]"><?php echo esc_html( $label_data ); ?></label>
                                            <input class="wp-travel-engine" value="<?php echo isset( $value[$i] ) ? esc_attr( $value[$i] ): '';?>" type="text" name="wp_travel_engine_booking_setting[place_order][relation][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" id="wp_travel_engine_booking_setting[place_order][relation][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" >
                                        <?php
                                    break;
                                    } ?>
                                </div>  
