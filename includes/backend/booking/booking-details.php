...
$exclude_info_filtered_array = ['stripeToken','stripeTokenType','stripeEmail','payment_gateway','paymentid','payerid','token','mihpayid','txnid','status','acode','atid','atype','amethod','aemail','wte_paypal_express_payment_token','wte_paypal_express_payment_details'];
