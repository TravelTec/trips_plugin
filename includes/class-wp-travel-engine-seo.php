...
class Wp_Travel_Engine_SEO {
    ...
    public static function wp_travel_engine_json_ld( $post_id = false ){
        ...
        $schema_values_json = json_encode( self::wp_travel_engine_schema_values( $post_id ) );
    ...
    public static function wp_travel_engine_schema_values( $post_id = false ){
        ...
        if ( isset( $wp_travel_engine_settings['faq']['title'] ) && $wp_travel_engine_settings['faq']['title'] != '' ) {
            ...
            $faq_schema_array = apply_filters( 'wp_travel_engine_faq_schema_array', array(
                '@context'   => 'http://schema.org',
                '@type'      => 'FAQPage',
                'mainEntity' => $faqs
            ), $post_id, $wp_travel_engine_settings );

            $faq_schema_values_json = json_encode( $faq_schema_array );
        ...
        $schema_array = apply_filters( 'wp_travel_engine_schema_array', array(
            '@context'    => 'http://schema.org',
            '@type'       => 'Trip',
