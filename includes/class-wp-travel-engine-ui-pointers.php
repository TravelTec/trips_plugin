    ...
    */
	function admin_print_footer_scripts () {
        ...
        $tour_trip_options = array (
            ...
            'position'      => array (  'edge' => 'bottom', 'align' => 'left', 'pointerClass' => 'wp-pointer wte-pointer'),
            ...
            (function ($) {
                ...
                wp_pointers_tour_opts = $.extend (wp_pointers_tour_opts, {
                    ...
                    close: function () {
                        ...
                        $.post (ajaxurl, {
                            pointer: '<?php echo $wte_usermeta_name;?>',
                ...
                if (wp_pointers_tour_opts.position && wp_pointers_tour_opts.position.defer_loading) {
                    ...
                    $('html,body').animate({
    		            scrollTop: $('<?php echo $id; ?>').offset().top
    		        }, 'slow');
    			}
                else {
                    setup ();
