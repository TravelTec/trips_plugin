jQuery(document).ready(function($) {
    ...
    */
    $( document ).on( 'click', '.obp-btn-submit-continue', function(e) {
        ...
        form_data['ajax_nonce']   = WPTEOB_OBJ.ajax_nonce;
        $.ajax({
    ...
    */
    ...
    $(document).on("click",".wte-onboard-paypal-payment",function() {
        $('.wpte-onoff-popup').slideToggle();
        $(this).toggleClass('active');
           if(payment_gw_checkbox.prop("checked")==true){
             payment_gw_checkbox.prop("checked", false); 
           }else{
             payment_gw_checkbox.prop("checked", true)
           }
    });
