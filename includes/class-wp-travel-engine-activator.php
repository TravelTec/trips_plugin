...
class Wp_Travel_Engine_Activator {
	...
	public static function activate() {
		 ...
		 */
			...
			$pages = apply_filters(
				...
				'wp_travel_engine_create_pages', array(

					'wp-travel-engine-cart'      => array(

						'name'    => _x( 'wp-travel-engine-cart', 'Page slug', 'wp-travel-engine' ),
					...
					'wp-travel-engine-checkout'  => array(
						...
						'name'    => _x( 'wp-travel-engine-checkout', 'Page slug', 'wp-travel-engine' ),

						'title'   => _x( 'WP Travel Engine Checkout', 'Page title', 'wp-travel-engine' ),

						'content' => '[' . apply_filters( 'wp_travel_engine_checkout_shortcode_tag', 'wp_travel_engine_checkout' ) . ']',

					),

					'my-account' => array(

						'name'    => _x( 'my-account', 'Page slug', 'wp-travel-engine' ),

						'title'   => _x( 'WP Travel Engine Dashboard', 'Page title', 'wp-travel-engine' ),
		...
		foreach ( $pages as $key => $page ) {
			...
			wp_travel_engine_create_page( esc_sql( $page['name'] ), 'wp_travel_engine_' . $key . '_page_id', $page['title'], $page['content'], ! empty( $page['parent'] ) ? wp_travel_engine_get_page_id( $page['parent'] ) : '' );
	...
	public static function create_roles() {
		...
		add_role( 'wp-travel-engine-customer', __( 'WP Travel Engine Customer', 'wp-travel-engine' ), array(
	...
	public static function activate_old () {
		...
		$pages = array(
			...
			'wp_travel_engine_destinations'	=> array(
				...
				array(
					...
					'field_id' => array
						...
						(
							...
							'2' => __( 'Tamanho do grupo', 'wp-travel-engine' ),

							'3' => __( 'Altitude máxima', 'wp-travel-engine' ),

							'4' => __( 'Acomodações', 'wp-travel-engine' ),

							'5' => __( 'Fitness', 'wp-travel-engine' ),

							'6' => __( 'Chegada', 'wp-travel-engine' ),

							'7' => __( 'Partida', 'wp-travel-engine' ),

							'8' => __( 'Melhor época', 'wp-travel-engine' ),

							'9' => __( 'Guia', 'wp-travel-engine' ),

							'10' => __( 'Tipo de viagem', 'wp-travel-engine' ),

							'11' => __( 'Refeições', 'wp-travel-engine' ),

							'12' => __( 'Idiomas', 'wp-travel-engine' ),

							'13' => __( 'Cancelamento', 'wp-travel-engine' ),
