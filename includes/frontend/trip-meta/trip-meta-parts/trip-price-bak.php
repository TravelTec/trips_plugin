        ...
        <div class="price-holder">
                    ...
                    <?php
                        ...
                        <strong class="price">
                            <?php
                                ...
                                echo '<span class="currency-code">'.esc_attr( $code ).'</span>&nbsp;';
                                echo '<span class="currency">'.esc_attr($currency).'</span>&nbsp;';
                                echo '<strong class="trip-cost-holder">'.esc_attr( $obj->wp_travel_engine_price_format($prev_cost) ).'</strong>';
                                echo '<span class="per-person">'.$person_format.'</span>';
                            ?>
                        </strong>
                    <?php
            ...
            <form id="booking-frm-<?php echo esc_attr( $post->ID ); ?>" autocomplete='off' method="POST" action="<?php echo esc_url( get_permalink( $wp_travel_engine_placeorder ) );?>">
                ...
                <div class="travelers-number-input">
                    ...
                    echo apply_filters('wp_travel_engine_no_of_travelers_text', $no_of_travelers);?></label>
                ...
                if( class_exists( 'Wp_Travel_Engine_Group_Discount' ) && isset( $wp_travel_engine_setting['group']['discount'] ) && isset( $wp_travel_engine_setting_option_setting['group']['discount'] ) )
                {
                    ...
                    echo '<div class="discount-price-per-traveler"><strong>'.__('Cost Per Adult Traveler: ','wp-travel-engine').'</strong><div class="per-adult-amount"><span class="currency">'.$currency.' </span><span class="discount-price-traveler">'.$actual_price.'</span>&nbsp;<span class="currency-code">'.$code.'</span></div></div>';
                    ...
                    {
                        echo '<div class="discount-price-per-child-traveler"><strong>'.__('Cost Per Child Traveler: ','wp-travel-engine').'</strong><div class="per-adult-amount"><span class="currency">'.$currency.' </span><span class="discount-price-child-traveler">'.$actual_price.'</span>&nbsp;<span class="currency-code">'.$code.'</span></div></div>';
                    }
                } ?>
