...
<style type="text/css">
	.p_shortcode{
		background-color: #ddd;padding: 5px 12px 7px 12px;width: 46%;margin-left: 30%;margin-bottom: -5.8%;
	}
	@media (min-width: 1270px) and (max-width: 1698px){
		.p_shortcode{
			background-color: #ddd;padding: 5px 12px 7px 12px;width: 46%;margin-left: 31%;margin-bottom: -6%;
		}
	}
	@media (min-width: 1720px){
		.p_shortcode{
			background-color: #ddd;padding: 5px 12px 7px 12px;width: 46%;margin-left: 19.5%;margin-bottom: -3.8%;
		}
	}
</style>

<?php if($_GET['taxonomy'] == 'activities'){ 
...
<p class="p_shortcode" style=""><strong>Shortcode:</strong> <?=$shortcode?></p>
