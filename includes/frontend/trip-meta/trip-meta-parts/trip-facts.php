                    ...
                    <div class="wte-trip-facts">
                        ...
                        <ul  class="trip-facts-value">
                             ...
                             foreach ($trip_facts['field_type'] as $key => $value) {
...

                                {
                                    ...
                                    if( isset( $wp_travel_engine_setting['trip_facts'][$key][$key] ) && !empty( $wp_travel_engine_setting['trip_facts'][$key][$key] ) ) {
                                        ...
                                        echo '<li><span class="icon-holder"><i class="'.$icon.'" style="font-size:30px;margin-right:10px"></i></span>';
							...
							if ( $trip_minimum_age ) :
								...
								<li><span class="icon-holder"><i class="<?php echo $trip_minimum_age_icon;?>" style="font-size:30px;margin-right:10px"></i></span><div class="trip-facts-text">

										<label><?php esc_html_e( 'Idade mínima:', 'wp-travel-engine' ) ?></label>
							...
							if ( $trip_maximum_age ) :
								...
								<li><span class="icon-holder"><i class="<?php echo $trip_maximum_age_icon;?>" style="font-size:30px;margin-right:10px"></i></span><div class="trip-facts-text">

										<label><?php esc_html_e( 'Idade máxima:', 'wp-travel-engine' ) ?></label>
