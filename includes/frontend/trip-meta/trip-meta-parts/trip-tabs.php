                                                            ...
                                                            case 'wp_editor':
                                                                ...
                                                                if (isset($wp_travel_engine_postmeta_settings['tab_content'][$first . '_wpeditor']) && $wp_travel_engine_postmeta_settings['tab_content'][$first . '_wpeditor'] != '') {
                                                                    ...
                                                                    <div class="tab-anchor-wrapper">
                                                                        ...
                                                                        <h2 class="wte-tab-title"><a href="javascript:void(0);" id="<?=$count?>" class="nav-tab nb-tab-trigger<?php
                                                ...
                                                case 'wp_editor':
                                                    ...
                                                    if (isset($wp_travel_engine_postmeta_settings['tab_content'][$first . '_wpeditor']) && $wp_travel_engine_postmeta_settings['tab_content'][$first . '_wpeditor'] != '') {
                                                        ...
                                                        if (isset($saved_tabs['id'][$value]) && $saved_tabs['id'][$value] != '') {
                                                            ...
                                                            <div class="nb-<?php echo $first; ?>-configurations nb-configurations" <?php
                                                                            ...
                                                                            <div id="faq-tabs<?php echo esc_attr($value); ?>" data-id="<?php echo esc_attr($value); ?>" class="faq-row">
                                                                                ...
                                                                                <a class="accordion-tabs-toggle" href="javascript:void(0);">
                                                                                    ...
                                                                                    <div class="faq-title">
                                                                                        ...
                                                                                        <?php echo (isset($wp_travel_engine_tabs['faq']['faq_title'][$value]) ? esc_attr($wp_travel_engine_tabs['faq']['faq_title'][$value]) : ''); ?>
                                                        ...
                                                        if ($i != 1) {
                                                            ...
                                                            ?> style=" display:none;"
                                                             ...
                                                             ?>>
                                                                 ...
                                                                 <?php echo do_action('wpte_guide_list_single_trip'); ?>
