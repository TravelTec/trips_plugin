	...
	<form method="post" id="wp-travel-engine-order-form" method="post" name="wp-travel-engine-order-form" action="<?php echo esc_url($wp_travel_engine_confirm);?>">
		...
		<div class="place-order-form-primary-wrapper">
			<div class="wp-travel-engine-billing-details">
				<div class='relation-options-title'><?php $billing_details = __('Detatles do pagamento: ','wp-travel-engine'); echo apply_filters( 'wpte_billings_details_title',$billing_details);?></div>
				<div class="wp-travel-engine-billing-details-wrapper">
					...
					<div class='wp-travel-engine-billing-details-field-wrap'>
							...
							switch ($key) {
								...
								case 'fname':?>
								<label for="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]">Nome<span class="required">*</span></label>
								...
								case 'lname':?>
								<label for="<?php echo esc_attr( $key );?>">Sobrenome<span class="required">*</span></label>
								<input type="<?php echo $value['type'];?>" name="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]" id="<?php echo esc_attr( $key );?>" <?php if( $value['required'] == '1' ) { echo 'required';   } ?>>
								<?php
								break;
		...
		?>
			...
			<div id="wp-travel-engine-terms">
	            ...
	            ?>
	                <p style="color:red;">
	                    <?php //_e( 'Página da política de privacidade não publicada. Privacy Policy page not set or not published, please check Admin Dashboard > Settings > Privacy.', 'wp-travel-engine' ); ?>
	                </p>
	            <?php
	            }
				?>
