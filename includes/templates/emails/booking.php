...
$trip_details    = array(
	...
	'{tdate}'    => __( 'Data da viagem', 'wp-travel-engine' ),

	'{traveler}' => __( 'Total de passageiro(s)', 'wp-travel-engine' ),

);

$billing_details = array(

	'{fullname}'        => __( 'Nome', 'wp-travel-engine' ),

	'{user_email}'      => __( 'Email', 'wp-travel-engine' ),

	'{billing_address}' => __( 'Endereço', 'wp-travel-engine' ),

	'{city}'            => __( 'Cidade', 'wp-travel-engine' ),

	'{country}'         => __( 'Estado', 'wp-travel-engine' ),

);

$payment_details  = array(

	'{tprice}'     => __( 'Valor', 'wp-travel-engine' ),

	'{total_cost}' => __( 'Total', 'wp-travel-engine' ),
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="content-block">
						...
						<h3 class="aligncenter"><?php echo esc_html__( 'Roteiro: {trip_url}', 'wp-travel-engine' ); ?></h3>
									...
									<table class="invoice-items" cellpadding="0" cellspacing="0">
										...
										<tr>
											...
											<td class="title-holder" style="margin: 0;" valign="top">
												...
												<h3 class="alignleft"><?php echo esc_html__( 'Passageiros', 'wp-travel-engine' ); ?></h3>
										...
										<tr>
											...
											<td class="title-holder" style="margin: 0;" valign="top">
												...
												<h3 class="alignleft"><?php echo esc_html__( 'Pagamento', 'wp-travel-engine' ); ?></h3>
				...
				<tr>
					...
					<td class="content-block aligncenter">
						...
						<a href="{booking_url}"><?php _e( 'Veja a reserva no seu site', 'wp-travel-engine' ); ?></a>
