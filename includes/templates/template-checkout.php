			...
			<div class="wp-travel-engine-order-right-column">
				...
				<ul class="trip-property">
					...
					<li><span><?php esc_html_e( 'Trip Price:', 'wp-travel-engine' ) ?> </span>
						...
						<?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $trip_price_display ) ); ?>
					...
					<li>
						...
						<span><?php esc_html_e( 'Number of Travelers:', 'wp-travel-engine' ); ?> </span><span class="travelers-number"><?php echo esc_html( $pax_adults ); ?></span><input type="hidden" name="travelers[]" value="<?php echo esc_attr( $pax_adults ); ?>">
					...
					<?php
						...
						if ( '0' !== $pax_child && 0 !== $pax_child ) : ?>
							...
							<li>
								...
								<span><?php esc_html_e( 'Number of Child Travelers:', 'wp-travel-engine' ); ?> </span><span class="travelers-number"><?php echo esc_html( $pax_child ); ?></span><input type="hidden" name="travelers[]" value="<?php echo esc_attr( $pax_child ); ?>">
							...
							<li class="cart-trip-total-price wte-extra-services-row"><span style="width: auto;"><?php esc_html_e( 'Extra Service(s)', 'wp-travel-engine' ); ?></span>
								...
								<div class="extra-service">
									...
									<?php foreach( $trip_extras as $key => $extra ) : ?>
										...
										<span class="extra-service-cost wte-es-item-cost"><?php echo esc_html( $extra['qty'] ); ?> X <?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $extra['price'] ) ); ?></span>
									...
									<div class="extra-service-total-cost">
										...
										<span class="extra-service-cost"><?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $trip_totals['trip_extras_total'] ) ); ?></span>
						...
						<li class="cart-trip-total-price wte-extra-services-row"><span style="width: auto;"><?php esc_html_e( 'Discount(s)', 'wp-travel-engine' ); ?></span>
								...
								<div class="extra-service">
									...
									<?php foreach( $trip_discounts as $key => $discount ) : ?>
										...
										<span class="extra-service-cost wte-es-item-cost"><?php echo 'percentage' === $discount['type'] ? esc_html( $discount['value'] ) . '%' : esc_html( wp_travel_engine_get_formated_price_with_currency( $discount['value'] ) ); ?></span>
									...
									<div class="extra-service-total-cost">
										...
										<span class="extra-service-cost"><?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $trip_totals['discount'] ) ); ?></span>
			...
			<table id="wte-cart-table">
				...
				<thead>
					...
					<tr>
						...
						<th><?php esc_html_e( 'Total Traveler(s)', 'wp-travel-engine' ); ?></th>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo esc_html( $currency_symbol ); ?><span class="total-trip-price"><?php echo esc_html( wp_travel_engine_get_formated_price_separator( $trip_totals['total'] ) ); ?></span> <?php echo esc_html( $currency_code ); ?></td>
