...
if (isset($_GET['wte_gateway']) && !empty( $_GET['wte_gateway'] ) && (isset( $_GET['status'] ) && $_GET['status'] == 'success')):
	do_action( 'wp_travel_engine_after_partial_payment_gateway_redirect', $booking, $_GET['wte_gateway']);
endif;
?>
	<div class="thank-you-container">
		...
		<div class="detail-container">
			...
			<div class="detail-item">
				...
				<span class="value"><?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $booking_meta['total_cost'] , null, true ) ); ?></span>
			</div>

			<div class="detail-item">
				<strong class="item-label"><?php esc_html_e( 'Partial Payment #1 :', 'wp-travel-engine' ); ?></strong>
				<span class="value"><?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $booking_meta['partial_cost'] , null, true ) ); ?></span>
			</div>

			<div class="detail-item">
				<strong class="item-label"><?php esc_html_e( 'Partial Payment #2 :', 'wp-travel-engine' ); ?></strong>
				<span class="value"><?php echo esc_html( wp_travel_engine_get_formated_price_with_currency( $booking_meta['partial_due'] , null, true ) ); ?></span>
			</div>
			<div class="detail-item">
