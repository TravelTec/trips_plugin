                ...
                <div class="wpte-bf-checkout-form">
					...
					class="">
                            ...
                            if( wp_travel_engine_is_cart_partially_payable() ) :
                                ...
                                if ( ! empty( $partial_payment_data ) ) :
                                    if( 'amount' === $partial_payment_data['type'] ) :
                                        $trip_price_partial = wp_travel_engine_get_formated_price_with_currency_code( $partial_payment_data['value'], null, true );
                                        ...
                                        <div class="wpte-bf-radio-wrap">
                                            ...
                                            <?php
                                                if ( ! empty( $payment_method['info_text'] ) ) :
                                                    ?>
                                                        <div class="wpte-checkout-payment-info" style="display: none;"><?php echo esc_html( $payment_method['info_text'] ); ?></div>
                                                    <?php
                                                endif; 
                                            ?>
                                        </div>
                        ...
                        <div class="wpte-bf-field wpte-bf-submit">
                            <input type="submit" name="wp_travel_engine_nw_bkg_submit" value="<?php esc_attr_e( 'RESERVAR', 'wp-travel-engine' ); ?>">
                        </div>
