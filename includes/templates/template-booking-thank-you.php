...
if ( ! empty( $cart_items ) ) :
	...
	?>
		...
		<div class="thank-you-container">
			<h3 class="trip-details"><?php echo esc_html__( 'Detalhes da viagem:', 'wp-travel-engine' ); ?></h3>
			<div class="detail-container">

				<?php if ( isset( $_GET['booking_id'] ) && ! empty( $_GET['booking_id'] ) ) : ?>

					<div class="detail-item">
						<strong class="item-label"><?php esc_html_e( 'ID da reserva:', 'wp-travel-engine' ); ?></strong>
				...
				foreach ( $cart_items as $key => $cart_item ) :
					...
					<div class="detail-item">
						<strong class="item-label"><?php esc_html_e( 'Data:', 'wp-travel-engine' ); ?></strong>
					...
					if ( isset( $cart_item['multi_pricing_used'] ) && $cart_item['multi_pricing_used'] ) :
						...
						foreach ( $cart_item['pax'] as $pax_key => $pax ) :
							...
							?>
								<div class="detail-item">
									<strong class="item-label"><?php echo str_replace("Number of pax", "Valor por", esc_html( $pax_label )); ?></strong>
									<span class="value"><?php echo esc_html( $pax ); ?> X <?php echo wp_kses_post( wp_travel_engine_get_formated_price_with_currency( $per_pricing_price, null, true ) ); ?></span>
								</div>
					  ...
					  endforeach;
							...
							<div class="detail-item">
								...
								<span class="value"><?php echo esc_html( $cart_item['pax']['adult'] ); ?> X <?php echo wp_kses_post( wp_travel_engine_get_formated_price_with_currency( $travelr_per_pricing_price, null, true ) ); ?></span>
							</div>
							...
							if ( isset( $cart_item['pax']['child'] ) && 0 != $cart_item['pax']['child'] ) :
								...
								<div class="detail-item">
									...
									<span class="value"><?php echo esc_html( $cart_item['pax']['child'] ); ?> X <?php echo wp_kses_post( wp_travel_engine_get_formated_price_with_currency( $child_per_pricing_price, null, true ) ); ?></span>
								</div>
