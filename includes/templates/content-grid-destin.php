...
?>
<div class="category-trips-single" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" style="">
    <div class="category-trips-single-inner-wrap">
        <figure class="category-trip-fig">
            ...
            <div class="category-trip-group-avil">
                ...
                <span class="pop-trip-grpavil-txt"><?php echo apply_filters( 'wp_travel_engine_group_discount_available_text', __( 'Group discount Available', 'wp-travel-engine' ) ); ?></span>
            </div>
            <?php endif; ?>
            ...
            <div class="category-disc-feat-wrap">
                <div class="category-trip-discount">
                    <span class="discount-offer">
                        <span><?php echo sprintf( __( '%1$s%% ', 'wp-travel-engine' ), $discount_percent ); ?></span>
                    <?php _e( 'Off', 'wp-travel-engine' );?></span>
                </div>
            </div>
            <?php endif; ?>
        </figure>
        ...
        <div class="category-feat-ribbon">
            <span class="category-feat-ribbon-txt"><?php _e( 'Featured', 'wp-travel-engine' );?></span>
        ...
        <div class="category-trip-prc-title-wrap">
            ...
            <div class="category-trip-budget">
                <span class="price-holder">
                    <?php if( $on_sale ) : ?>
                    <span class="striked-price"><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $trip_price ); ?></span>
                    <?php endif; ?>
                    <span class="actual-price"><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $display_price ); ?></span>
                </span>
            </div>
            <?php endif; ?>
        ...
        <div class="category-trip-aval-time">
            <?php if( 'months_list' == $dates_layout && class_exists( 'WTE_Fixed_Starting_Dates' ) ) :
                ...
                $availability_txt     = ! empty( $trip_starting_dates ) && is_array( $trip_starting_dates ) ? __( 'Available in the following months:', 'wp-travel-engine' ) : __( 'Available throught out the year:', 'wp-travel-engine' );
            ...
            <?php if( 'dates_list' == $dates_layout ) :
                ...
                if ( ! empty( $trip_starting_dates ) && is_array( $trip_starting_dates ) ) : ?>
                    <div class="next-trip-info">
                        <div class="fsd-title"><?php esc_html_e( 'Next Departure', 'wp-travel-engine' );?></div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="17.332" height="15.61" viewBox="0 0 17.332 15.61">
        ...
        <path id="Path_23384" data-name="Path 23384" d="M150.612,112.52c0,.655,0,1.31,0,1.966a.216.216,0,0,0,.087.178,4.484,4.484,0,0,1,.358.346.227.227,0,0,0,.186.087q1.616,0,3.233,0a.659.659,0,0,1,.622.4.743.743,0,0,1-.516,1.074,1.361,1.361,0,0,1-.323.038q-1.507,0-3.013,0a.248.248,0,0,0-.216.109,1.509,1.509,0,0,1-.765.511,1.444,1.444,0,0,1-1.256-2.555.218.218,0,0,0,.09-.207q0-1.916,0-3.831a.784.784,0,0,1,.741-.732.742.742,0,0,1,.761.544.489.489,0,0,1,.015.127Q150.612,111.547,150.612,112.52Z" transform="translate(-423.686 -141.471)"/>
...
</i>'. wte_get_formated_date( $date['start_date'] ) .'</span><span class="right">' . sprintf( __( '%1$s Available', 'wp-travel-engine' ), $date['seats_left'] ) . '</span></li>';
                            endforeach; ?>
            ...
            <a href="<?php the_permalink(); ?>" class="button category-trip-viewmre-btn">Ver Detalhes</a>
        </div>
    </div>
</div>
