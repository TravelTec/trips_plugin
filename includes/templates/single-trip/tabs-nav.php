            ...
            <div class="tab-inner-wrapper">
                ...
                <?php foreach ( $tabs['id'] as $key => $value ) : ?>
                    ...
                    <?php 
                        ...
                        if ($tabs['name'][$value] == 'Itinerário') { 

                            if (!empty($wp_travel_engine_tabs['trip_itinerary_title'])) {
                    ...
                    ?>
                                ...
                                <div class="tab-anchor-wrapper">
                                    ...
                                    <h2 class="wte-tab-title">
                                        ...
                                        <a href="javascript:void(0);"  id="tab-roteiro"  data-value="<?=$count?>" 

                                            class="nav-tab nb-tab-trigger tab-roteiro<?=$count?> <?php
                        ...
                        <?php }else{ ?>
                            ...
                            <div class="tab-anchor-wrapper">
                                    ...
                                    <h2 class="wte-tab-title">
                                        ...
                                        <a href="javascript:void(0);"  id="tab-roteiro<?=$count?>"  data-value="<?=$count?>"
