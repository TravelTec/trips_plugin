...
?>
<div class="wpte-lrf-wrap wpte-login" <?php echo $login_form_toogle; ?>>
...
<?php if ( 'yes' !== $disable_my_account_customer_registration ) : ?>
	<div class="wpte-lrf-wrap wpte-register" <?php echo $reg_form_toogle; ?>>
		<div class="wpte-lrf-top">
			<div class="wpte-lrf-head">
				<?php if ( has_custom_logo() ) : ?>
					<div class="wpte-lrf-logo">
			...
			?>
					<div class="wpte-lrf-footer">
						<?php 
							printf( __( 'By signing up, you agree to our <a href="%1$s" id="terms-and-conditions" target="_blank"> Terms and Conditions</a> and <a href="%2$s" id="privacy-policy" target="_blank">Privacy Policy</a>.', 'wp-travel-engine'), esc_url( get_permalink( $wp_travel_engine_terms_conditions ) ), esc_url( get_privacy_policy_url()) ); 
						?>
					</div>
			<?php 
				}
