...
<form method="post" class="wpte-lrf-form">
	...
	<div class="wpte-lrf-field lrf-text">
		<label class="lrf-field-label" for="lrf-address"><?php _e( 'Address:', 'wp-travel-engine' ); ?> </label>
		<input type="text" name="customer_billing_address" id="customer_billing_address" value="<?php echo esc_attr( $billing_address ); ?>" />
	</div>

	<div class="wpte-lrf-field lrf-text">
		<label class="lrf-field-label" for="customer_billing_city"><?php _e( 'City:', 'wp-travel-engine' ); ?></label>
	...
	<div class="wpte-lrf-field lrf-number">
		<label class="lrf-field-label" for="customer_zip_code"><?php _e( 'Zip/Postal Code:', 'wp-travel-engine' ); ?></label>
		<input type="text" name="customer_zip_code" id="customer_zip_code" value="<?php echo esc_attr( $billing_zip ); ?>" />
	</div>

	<div class="wpte-lrf-field lrf-text">
		<label class="lrf-field-label" for="lrf-country"><?php _e( 'Country:', 'wp-travel-engine' ); ?></label>
		<select id="lrf-country" class="selectpicker form-control" name="customer_country">
	...
	<div class="wpte-lrf-field lrf-tel">
		<label class="lrf-field-label" for="lrf-phone"><?php _e( 'Phone:', 'wp-travel-engine' ); ?></label>
		<input type="text" name="customer_phone" id="lrf-phone" value="<?php echo esc_attr( $billing_phone ); ?>" />
	</div>

	<?php do_action( 'wp_travel_engine_edit_billing_form' ); 
...
<?php do_action( 'wp_travel_engine_after_edit_billing_form' );
