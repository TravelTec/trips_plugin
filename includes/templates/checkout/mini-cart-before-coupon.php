    ...
    <div class="wpte-bf-book-summary">
                ...
                <table class="wpte-bf-summary-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><b><?php echo wp_kses_post( wp_travel_engine_get_formated_price_with_currency_code_symbol( $cart_item['pax_cost'][ $pax_label ], null, true ) ); ?></b></td>
                        </tr>
					<?php endforeach; ?>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                ...
                                <?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $cart_totals['sub_total'] , null, true ); ?>
                            </td>
                        </tr>
                            ...
                            foreach( $cart_discounts as $discount_key => $discount_item ) { ?>
                             <tr class="wte-coupons-discount-calculation-tr">
                                ...
                                <td class="wte-coupons-discount-calculation-td">
                                    ...
                                    ?>
                                    <span class="wpte-price"><?php echo $new_tcost; ?></span>
                                    <?php
                                    ...
                                    ?>
                                    <span class="wpte-price"><?php echo $discount_amount_actual; ?></span>
                                    <?php }else{
                    ...
                    <table class="wpte-bf-extra-info-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="wpte-remain-amt"><b><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( ( $cart_totals['sub_total'] - $cart_totals['total_partial'] ), null, true ); ?></b></td>
                            </tr>
                        </tbody>
                    </table>
                <?php endif; ?>
        ...
        ?>
            <div class="wpte-bf-total-price">
                ...
                <span class="wpte-price"><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $payable_now, null, true ); ?>
                </span>
            </div>
