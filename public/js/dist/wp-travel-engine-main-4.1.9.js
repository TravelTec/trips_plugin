jQuery(document).ready(function ($) { 
    ...
    function populateHTML() {
        ...
        wte.currency.code = $("#currency_code").val();
        wte.currency.symbol = $("#currency_code").val(); 

        // Calculate total.
        var travellersCost = calculateTravellersTotalCost();
        window.wte.trip.travellersCost = travellersCost;
        var grandTotal = wteGetFormatedPrice(travellersCost);
        var formattedTravellersCost = wteGetFormatedPrice(travellersCost);
        var formattedGrandTotal = wteGetFormatedPrice(grandTotal);
        var formattedGrandTotalWithCodeSymbol = wte.currency.symbol+' '+wteGetFormatedPrice(travellersCost);
        ...
        $(".wpte-bf-total-price > .wpte-price").html(grandTotal);
...
function wteGetFormatedPriceWithCurrencyCodeSymbol(
    ...
    var currency_option = $("#currency_code").val();
    var currency_symbol_display = $("#currency_code").val();  
...
function calculateGrandTotal() {
    var travellersCost = window.wte.trip.travellersCost;
    var extraServicesCost = window.wte.trip.extraServicesCost;
